...
Before tagging `0.1.1`, verify:

1. `package.json` version is `0.1.1`
...
```bash
docker pull dandacompany/deskrpg:0.1.1
...
```bash
JWT_SECRET=change-me DESKRPG_IMAGE=dandacompany/deskrpg:0.1.1 \
...
- The release tag format is currently `0.1.1`, not `v0.1.1`
